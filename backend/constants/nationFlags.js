...
// those flagless — resolve through accent folding + a normalised index so
// every variant finds its flag. Mirrors frontend/src/constants/nationFlags.js.
...
export function flagIso(name) {
  return NATION_ISO2[name] || NORM_INDEX[normName(name)] || null;
}
