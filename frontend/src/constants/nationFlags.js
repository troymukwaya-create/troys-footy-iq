...
export const NATION_ISO2 = {
  ...
  // Friendlies can involve ANY FIFA nation — full coverage so no tile
  // ever falls back for want of a mapping.
  Grenada: 'gd', Barbados: 'bb', Bermuda: 'bm', Belize: 'bz',
  'Antigua and Barbuda': 'ag', 'Saint Lucia': 'lc', 'St. Lucia': 'lc',
  'Saint Kitts and Nevis': 'kn', 'Saint Vincent and the Grenadines': 'vc',
  Dominica: 'dm', Bahamas: 'bs', 'Puerto Rico': 'pr', Aruba: 'aw',
  ...
  Macau: 'mo', 'Chinese Taipei': 'tw', Taiwan: 'tw', Philippines: 'ph',
  Singapore: 'sg', Brunei: 'bn', 'Timor-Leste': 'tl', Guam: 'gu',
  Yemen: 'ye',
  Fiji: 'fj', 'Papua New Guinea': 'pg', 'Solomon Islands': 'sb',
  Vanuatu: 'vu', Samoa: 'ws', 'American Samoa': 'as', Tonga: 'to',
  Tahiti: 'pf', 'New Caledonia': 'nc', 'Cook Islands': 'ck',
  Ethiopia: 'et', Eritrea: 'er', Djibouti: 'dj', Somalia: 'so',
  Tanzania: 'tz', Rwanda: 'rw', Burundi: 'bi', Malawi: 'mw',
  Zimbabwe: 'zw', Botswana: 'bw', Lesotho: 'ls', Eswatini: 'sz',
  Swaziland: 'sz', Madagascar: 'mg', Mauritius: 'mu', Comoros: 'km',
  Seychelles: 'sc', 'Equatorial Guinea': 'gq', Chad: 'td',
  'Central African Republic': 'cf', Congo: 'cg', 'Congo Republic': 'cg',
  Gambia: 'gm', 'The Gambia': 'gm', 'Guinea-Bissau': 'gw',
  'Sierra Leone': 'sl', Liberia: 'lr', Niger: 'ne', Mauritania: 'mr',
  'South Sudan': 'ss', 'São Tomé and Príncipe': 'st',
  Andorra: 'ad', 'San Marino': 'sm', Liechtenstein: 'li',
  'Faroe Islands': 'fo', Gibraltar: 'gi', Monaco: 'mc',
};
